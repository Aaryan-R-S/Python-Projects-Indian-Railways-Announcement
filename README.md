...
<p align="center">
  ...
  <h3 align="center">Indian Railways Announcement</h3>
...
This is a python app which can automate Indian Railway Announcement system! It is a great utility for INR which I prefer to quickly get their work stuff done.
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Indian-Railways-Announcement.git
   ```
- Python Modules
  - `pip install pandas`
  - `pip install gTTS` 
